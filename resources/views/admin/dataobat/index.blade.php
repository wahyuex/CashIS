    ...
    <div class="container mt-4">
        ...
        <div class="table-responsive border p-3 rounded-3 mb-5">
            <table class="table table-bordered table-hover table-striped mb-0 bg-white datatable" id="employeeTable">
                ...
                <tbody>
                    @foreach ($listobats as $index => $listobat)
                                ...
                                <div class="d-flex text-center">
                                    ...
                                    <div>
                                        <form action="{{ route('dataobat.destroy', ['dataobat' => $listobat->id]) }}" method="POST">
                                            @csrf
                                            @method('delete')
                                            <button type="submit" class="btn btn-outline-light btn-sm me-2  btn-delete" data-name="{{ $listobat->name }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black" class="bi bi-trash" viewBox="0 0 16 16">
